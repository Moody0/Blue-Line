...
export const metadata: Metadata = {
  title: "الاستبدال والاسترجاع | بلو لاين لأدوات السباكة",
  description: "شروط وإجراءات استرجاع واستبدال المنتجات خلال ١٤ يوماً من متجر بلو لاين.",
};

export default async function ReturnsPage() {
  const settings = await getSiteSettings();
  const returns = settings.policies_content?.returns || {
    title: "سياسة الاستبدال والاسترجاع",
    subtitle: "حق الاسترجاع والاستبدال مكفول لجميع عملائنا خلال ١٤ يوماً من تاريخ الاستلام وفقاً لأحكام قانون حماية المستهلك المصري.",
    ...
    <div className="min-h-[70vh] py-8 sm:py-14 font-alexandria" dir="rtl">
      <div className="max-w-[1000px] mx-auto px-4 sm:px-6 space-y-8 text-start">
        ...
        <nav aria-label="مسار التصفح" className="flex items-center gap-2 text-xs text-text-muted">
          ...
          <span>/</span>
          <span className="text-brand-900 font-bold">الاستبدال والاسترجاع</span>
        </nav>
        ...
        <div className="pt-6 border-t border-border-default flex flex-wrap items-center gap-4">
          ...
          >
            ...
            <span className="inline-flex items-center gap-1">
              <span>طلب استرجاع عبر واتساب</span>
