...
export function FooterClient({
  ...
  return (
    <div className="space-y-8">
      {/* ────────────────────────────────────────────────────────── */}
      {/* 1. MOBILE VIEW (< md screens)                             */}
      {/* ────────────────────────────────────────────────────────── */}
      <div className="block md:hidden space-y-6 text-start">
        {/* ── Brand & Store Information (Always Visible, Not Collapsed) ── */}
        <div className="space-y-3.5 pb-4 border-b border-white/10">
          ...
          <div className="space-y-2 text-xs text-surface-200/90 pt-1">
          ...
          {/* Permanently Visible Social Icons */}
        ...
        {/* ── Collapsible Link Accordions ── */}
        <div className="space-y-0 divide-y divide-white/10">
          {/* Section 1: Categories / Quick Links */}
          <div className="py-4">
            <button
              type="button"
